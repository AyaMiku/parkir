...
module.exports = {
    Register: async (req, res) => {
        try {
            ...
            if (!usernameRegex.test(username)) {
                ...
                return res.status(400).json({ message: "Username harus mengandung huruf, boleh ditambah angka atau underscore." });
            }
    ...
    Login: async (req, res) => {
        try {
            ...
            console.log("✅ User ditemukan:", { id: userData.id, email: userData.email, role: userData.role });
